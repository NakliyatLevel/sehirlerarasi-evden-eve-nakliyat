  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold text-primary">Sayfa Yönetimi</h1>
          <p className="text-muted-foreground mt-2">Dinamik sayfaları yönetin</p>
        </div>
        <Link href="/karakar/sayfalar/yeni">
          <Button>
                ...
                <tr key={page.id}>
                  ...
                  <td className="px-6 py-4">
                    <div className="flex items-center justify-end gap-2">
                      <Link href={`/karakar/sayfalar/${page.id}`}>
